...
При успешном выполнении запроса вы открепите студента от текущей учебной организации.

### 3.7 Получение ID студента по его ID в мессенджере MAX, Telegram или ВКонтакте
